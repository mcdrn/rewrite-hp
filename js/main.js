...
document.addEventListener("DOMContentLoaded", function () {
    const toggleBtns = document.querySelectorAll(".toggle-btn-footer");
    ...
    const header = document.getElementById(".index-text-en-pc-main");
header.addEventListener("click", () => {
  header.classList.toggle("circle");
});
const navLinks = document.querySelectorAll(".index-text-en-pc");
